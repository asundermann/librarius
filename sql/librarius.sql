...
-- Vytvořeno: Pát 08. zář 2023, 08:53
-- Verze serveru: 8.0.29
-- Verze PHP: 8.1.0
...
--
ALTER TABLE `books`
  ADD CONSTRAINT `books_ibfk_1` FOREIGN KEY (`user_published_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `books_ibfk_2` FOREIGN KEY (`user_edited_id`) REFERENCES `users` (`id`);
COMMIT;
